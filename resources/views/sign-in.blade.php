...
<body class="bg-stone-100 mb-72">
    ...
    <div class="flex flex-col items-center justify-center py-32 text-center space-y-8 ">
        ...
        <div class="flex items-center justify-between px-6 mb-6  sm:space-x-22 lg:space-x-32">
            ...
            <a href="/"
               class="-ml-56 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-md transition">
                ← Aceuille
            </a>
        ...
        <div class="space-y-2">
            ...
            <h2 class="text-lg text-green-600 font-extrabold">
                Creer votre compte Glisse maintenant ,
                <br>
    ...
    <div>
        ...
        <div>
            ...
            <label for="password" class="block text-white font-semibold mb-1">Rewrite your Password</label>
            <input id="password" name="password" class="w-full border border-black rounded-md p-2">
    ...
    <button type="submit"
        ...
        <div class="mt-6 ml-11" >
            ...
            <p> Tu as deja un compte Glisse ? <a class="text-stone-100 hover:text-stone-200" href="/log-in">Log In !</a></p>
